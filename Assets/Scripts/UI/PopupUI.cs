...
namespace AR_Project.Scripts.AndroidNativeFunctionality
{
    public class PopupUI : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("m_BackCanvas")] public CanvasGroup backCanvas;
        [FormerlySerializedAs("m_onYes")] public Button oNYes;
        [FormerlySerializedAs("m_onNo")] public Button oNNo;
